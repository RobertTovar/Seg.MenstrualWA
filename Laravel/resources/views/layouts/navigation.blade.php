...
<div class="alert alert-warning alert-dismissible fade show" role="alert">
    ...
    {{ __('vaccines and alterations in the menstrual cycle of women.')}}
    <b>
        {{ __('NOTE: THIS RESEARCH DOES NOT ENCOURAGE PEOPLE TO DO NOT GET VACCINATED,') }}
        {{ __('REMEMBER THAT VACCINATION IS ESSENTIAL FOR THE PREVENTION AGAINST COVID19.')}}
    </b>
